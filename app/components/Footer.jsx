                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    >
                        ...
                        <div className="border-t border-white/30 pt-4 flex justify-center">
                            <h3 className="text-5xl font-semibold! text-[#806a56] mb-4">{t('contactUs')}</h3>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <div className="text-[#806a56] font-bold! text-lg mb-1">{t('ourPhone')}</div>
                                    <div className="font-semibold text-md">079 467 2928</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <div className="text-[#806a56] font-bold! text-lg mb-1">{t('ourEmail')}</div>
                                    <div className="font-semibold text-md">antwedding79@gmail.com</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <div className="text-[#806a56] font-bold! text-lg mb-1">{t('ourAddress')}</div>
