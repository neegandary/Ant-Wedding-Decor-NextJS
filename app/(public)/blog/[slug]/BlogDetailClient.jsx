          ...
          <aside className="lg:w-84 shrink-0">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              ...
              <nav className="space-y-2">
                <Link href="/blog" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                  {t('allCategories')}
                </Link>
                <Link
                  href="/blog?category=cam-nang"
                  className={`block px-4 py-2 rounded-lg transition-colors ${blog.category === 'cam-nang' ? 'bg-[#cbb9a4] text-white font-medium' : 'text-gray-700 hover:bg-gray-100'}`}
                >
                  {t('camNang')}
                </Link>
                <Link
                  href="/blog?category=real-life-wedding"
                  className={`block px-4 py-2 rounded-lg transition-colors ${blog.category === 'real-life-wedding' ? 'bg-[#cbb9a4] text-white font-medium' : 'text-gray-700 hover:bg-gray-100'}`}
                >
                  {t('realLifeWedding')}
                </Link>
                <Link
                  href="/blog?category=tu-van-dam-cuoi"
                  className={`block px-4 py-2 rounded-lg transition-colors ${blog.category === 'tu-van-dam-cuoi' ? 'bg-[#cbb9a4] text-white font-medium' : 'text-gray-700 hover:bg-gray-100'}`}
                >
                  {t('tuVanDamCuoi')}
                </Link>
                <Link
                  href="/blog?category=chuyen-nghe"
                  className={`block px-4 py-2 rounded-lg transition-colors ${blog.category === 'chuyen-nghe' ? 'bg-[#cbb9a4] text-white font-medium' : 'text-gray-700 hover:bg-gray-100'}`}
                >
                  {t('chuyenNghe')}
                </Link>
              </nav>
          ...
          <div className="flex-1">
            <article className="bg-white rounded-lg shadow-md p-8 md:p-12">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {relatedBlogs.map((relatedBlog) => {
                      ...
                      return (
                        <Link key={relatedBlog._id} href={`/blog/${relatedBlog.slug}`} className="group cursor-pointer">
              ...
              <div className="text-center py-8 mt-8 border-t border-gray-200">
                <Link href="/blog" className="inline-flex items-center px-6 py-3 bg-[#cbb9a4] text-white rounded-lg hover:bg-[#b5a894] transition-colors">
